...
struct S202 {
    int field_0;                    // 0x00
    S202* self;                     // 0x04
    class CarSystemManager* carMgr;       // 0x08
    int field_C;                    // 0x0C
    void* field_10;                 // 0x10
...
public:
    ...
    bool sub_42A850(unsigned char a2, unsigned char a3, unsigned char a4);
...
// ==== импорт имён из gm ====
    // 6 функций
    // 0x004637A0: MapRelatedStruct::FetchStoredId
    void FetchStoredId() {};
    // 0x00463EF0: MapRelatedStruct::SetFlagValue
    void SetFlagValue() {};
    // 0x00463F10: MapRelatedStruct::RefreshFlag
    void RefreshFlag() {};
    // 0x00463F50: MapRelatedStruct::Clear
    void Clear() {};
    // 0x00464C40: MapRelatedStruct::AllocNode
    void AllocNode() {};
    // 0x00464C60: MapRelatedStruct::FreeNode
    void FreeNode() {};

    // 0x00462CB0
    // (gm) ������: MapRelatedStruct::GetMapFieldPtr -> MapRelatedStruct::GetElement
    int GetElement(int arg0, int arg1) {};
    // 0x00463210
    // (gm) ������: Map::GetNextTrainPosition -> MapRelatedStruct::ResolveMapPosition
    void ResolveMapPosition(int arg0, int arg1) {};
    // 0x00463690
    // (gm) ������: Map::LineCrossesRegion -> MapRelatedStruct::CollidesWithPed
    int CollidesWithPed(int arg0, int arg1, int arg2) {};
    // 0x00463760
    // (gm) ������: Map::ProjectPointToScreen -> MapRelatedStruct::Update
    void Update() {};
    // 0x004637B0
    // (gm) ������: Map::ResetPoint3D -> MapRelatedStruct::Reset
    void Reset(int arg0) {};
    // 0x00463940
    // (gm) ������: FillTileTable -> MapRelatedStruct::LoadTileData
    void LoadTileData(int arg0, int arg1) {};
    // 0x00463A00
    // (gm) ������: AppendTileRecord -> MapRelatedStruct::AddPoint
    void AddPoint(int arg0, int arg1) {};
    // 0x00463A40
    // (gm) ������: MoveTileRecord -> MapRelatedStruct::DuplicatePoint
    int DuplicatePoint(int arg0, int arg1) {};
    // 0x00463A90
    // (gm) ������: AppendTileRange -> MapRelatedStruct::DuplicateHeight
    void DuplicateHeight(int arg0, int arg1) {};
    // 0x00463AE0
    // (gm) ������: CopyTileRange -> MapRelatedStruct::SplitHeight
    int SplitHeight(int arg0, int arg1, int arg2) {};
    // 0x00464160
    // (gm) ������: MapRelatedStruct::UpdateTileColumn -> MapRelatedStruct::ReduceHeight
    void ReduceHeight(int arg0, int arg1, int arg2) {};
    // 0x00464330
    // (gm) ������: MapRelatedStruct::BuildMapFieldTables -> MapRelatedStruct::ParseNames
    void ParseNames(int arg0) {};
    // 0x00465350
    // (gm) ������: MapRelatedStruct::GetGangAtLocation -> MapRelatedStruct::GetGangByName
    void* GetGangByName(int arg0) {};
    // 0x00465510
    // (gm) ������: MapRelatedStruct::GetTileStyleForEvent1 -> MapRelatedStruct::GetXStyle
    int GetXStyle(int arg0) {};
    // 0x004655B0
    // (gm) ������: MapRelatedStruct::GetTileStyleForEvent2 -> MapRelatedStruct::GetYStyle
    int GetYStyle(int arg0) {};
    // 0x00466620
    // (gm) ������: MapRelatedStruct::CheckTrainInTube -> MapRelatedStruct::CheckCarTop
    int CheckCarTop(int arg0, int arg1) {};
    // 0x00466AF0
    // (gm) ������: MapRelatedStruct::GetGroundStateAt -> MapRelatedStruct::CheckCarPosition
    int CheckCarPosition(int arg0) {};
    // 0x004690B0
    // (gm) ������: Car::IsPointVisibleToAnyPlayer -> MapRelatedStruct::IsPointVisible
    void IsPointVisible() {};
};
