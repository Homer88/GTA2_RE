...
//=============================================================================
bool MapRelatedStruct::sub_48A350(unsigned char a2, unsigned char a3, unsigned char a4)
{
  int v4;

  //v4 = sub_42A850( a2, a3, a4);
  return 0;// v4 && (*(_BYTE *)(v4 + 11) & 3) != 0;
...
bool MapRelatedStruct::sub_4B9F40(int a2, int a3, int a4)
{
  ...
  //v4 = sub_4653C0( a2, a3, a4);
  return 0;//v4 && Style::sub_49E540(gStyle, *(_WORD *)(v4 + 8) & 0x3FF);
...
//=============================================================================
char *MapRelatedStruct::sub_464EE0(unsigned char arg0, unsigned char a2, char a4)
{
  /*int v4;
  int v6;
  char *v7;
...
// 0x0042A850
bool MapRelatedStruct::sub_42A850(unsigned __int8 a2, unsigned __int8 a3, unsigned __int8 a4) {
    Map* Map = getMap();
...
// 0x00462CB0
int MapRelatedStruct::sub_462CB0(unsigned short a2) {
   // return (int)(field_334 + 22 * *(unsigned __int8*)(field_330 + a2));
    return 0;
}

// 0x00462CE0
_WORD* MapRelatedStruct::sub_462CE0(unsigned short a2, __int16 a3) {
...
// 0x00462D00
int MapRelatedStruct::sub_462D00(unsigned short a2, __int16 a3) {
...
// 0x00462D20
int MapRelatedStruct::sub_462D20(unsigned short a2, __int16 a3) {
    //int result = sub_462CB0(a2);
   // *(_WORD*)(result + 4) = a3;
    return 0;//result;
}
...
// 0x00462D40
int MapRelatedStruct::sub_462D40(unsigned short a2, __int16 a3) {
    //int result = sub_462CB0(a2);
    //*(_WORD*)(result + 6) = a3;
    return 0;//result;
}
...
// 0x00462D60
int MapRelatedStruct::sub_462D60(unsigned short a2, __int16 a3) {
    //int result = sub_462CB0(a2);
    //*(_WORD*)(result + 8) = a3;
    return 0;//result;
}
...
// 0x00462D80
int MapRelatedStruct::sub_462D80(unsigned short a2, __int16 a3) {
   // int result = sub_462CB0(a2);
    //*(_WORD*)(result + 10) = a3;
    return 0;//result;
}
...
// 0x00462DA0
int MapRelatedStruct::sub_462DA0(unsigned short a2, __int16 a3) {
   // int result = sub_462CB0(a2);
    //*(_WORD*)(result + 12) = a3;
    return 0;//result;
}
...
// 0x00462DC0
int MapRelatedStruct::sub_462DC0(unsigned short a2, __int16 a3) {
    //int result = sub_462CB0(a2);
    //*(_WORD*)(result + 14) = a3;
    return 0; //result;
}
...
// 0x00462DE0
int MapRelatedStruct::sub_462DE0(unsigned short a2, __int16 a3) {
    //int result = sub_462CB0(a2);
    //*(_WORD*)(result + 16) = a3;
    return 0;//result;
}
...
// 0x00462E00
int MapRelatedStruct::sub_462E00(unsigned short a2, __int16 a3) {
   // int result = sub_462CB0(a2);
   // *(_WORD*)(result + 18) = a3;
    return 0;//result;
}
...
// 0x00462E20
int MapRelatedStruct::sub_462E20(unsigned short a2, __int16 a3) {
    //int result = sub_462CB0(a2);
    //*(_WORD*)(result + 20) = a3;
    return 0;//result;
}
...
// 0x00462E40
char* MapRelatedStruct::sub_462E40(unsigned short a2) {
    return 0;//*(char**)(count + 4 * a2 + 4);
}
...
unsigned int MapRelatedStruct::sub_464250(unsigned int a2, unsigned int a3, unsigned int a4)
{
    ...
    return 0;//sub_463940(v4, (int)((char*)this + 4));
}
...
int MapRelatedStruct::sub_464640(FileMgr *dwBytes)
{
    ...
    return 0;//sub_4644E0((unsigned int)dwBytes);
}
...
int MapRelatedStruct::sub_464670(FileMgr *dwBytes)
{
   ...
   // Buffer_ANIM = Buffer;
    //FileMgr::Read(Buffer, (SIZE_T *)&dwBytes);
    return 0;//sub_464550((int)dwBytes);
}
...
/*Gang* MapRelatedStruct::sub_465350(int a2, int a3)
{
   // unsigned char v7 = Weapon::sub_41C1E0((Weapon *)&a3);
    ...
    if (v5)
        return gGangs.FindByName((int)(v5 + 6));
    else
        return 0;
}*/
...
int MapRelatedStruct::sub_4653C0(int a2, int a3, int a4) {
 ...
 //   return 0;
 // else
    return 0;//Map->field_4000C + 12 * *(_DWORD *)&v5[4 * (a4 - v6) + 4];
}
...
int MapRelatedStruct::sub_465490(int a2, int a3, int a4) {
 ...
 //   return 0;
 // else
    return 0;//Map->field_4000C + 12 * *(_DWORD *)(v10 + 4 * (a4 - v11) + 4);
}
...
// 0x4696C0
 int* MapRelatedStruct::sub_4696C0(int* arg0, AudioSourceParams* arg4){
