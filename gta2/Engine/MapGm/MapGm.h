...
public:
	...
	void SetAwardValue1(int value) { field_430 = value; }  // (gm) ������: SetCarCost -> SetAwardValue1
	...
	int EncodeBonusStage(unsigned char param2) { return (playerArena << 4) | param2; }
...
// ==== импорт имён из gm ====
    // 2 функций
    // 0x0045E5D0: MapGm::SetAwardValue2
    void SetAwardValue2();
