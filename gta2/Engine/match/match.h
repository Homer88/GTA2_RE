...
// RoundToInt = стандартное double->__int64, см. Sinus gta2.exe.c:12515).
//
...
public:
	...
	// (как RoundToInt - обычный double->int).
	...
	// Декодирование в целое: округление raw/16384 до ближайшего (как RoundToInt).
