...
//=============================================================================
// Map::GetMapCellPtr(0x0042A830)
// Index tile grid: returns pointer to (char*)this + 1024 * a2 + 4 * a3
//=============================================================================
char* Map::GetMapCellPtr(int a2, int a3)
{
...
{
    *(int*)GetMapCellPtr(y, x) = tileIndex;
}
...
int Map::FindTileForMaxZ(int x, int y, int* outZ)
{
    ...
    int* piVar1 = (int*)GetMapCellPtr(y, x);
