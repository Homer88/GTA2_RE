...
class Style{
    ...
    void SetTwoFields(int arg0,int arg1);
    // 0x00462FB0 undefined4 __thiscall
    int IsSlotAttrFour(int param_1,unsigned int param_2);
    // 0x00462FD0
    int StyleGetSlotAttr(void);
    // 0x00463020 byte __thiscall
    unsigned char IsInsideBounds(unsigned char param_1,unsigned char param_2);
    // 0x004B9F20
