...
inline void Menu::AreaCompliteMenuCreate() {
    ...
    this->MenuPageArray[MENUPAGE_AREA_COMPLETE].MenuEntryArray[BackToMainMenu].X = this->PrintCentr(
        this->MenuPageArray[MENUPAGE_AREA_COMPLETE].MenuEntryArray[BackToMainMenu].TextMenuElementArray, this->MenuPageArray[MENUPAGE_AREA_COMPLETE].MenuEntryArray[4].StringLength, 320);
...
unsigned char Menu::MultiplayerMenu(PlayerSlotSlave* PlayerSlotSave) {
    // TODO: Реализовать на основе ассемблерного кода
...
char Menu::ShowAwards(char arps) {
    // TODO: Реализовать на основе ассемблерного кода
