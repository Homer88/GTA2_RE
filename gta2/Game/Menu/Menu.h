...
public:
    ...
    int NumberLoadedTextures;               // +0x5008 - количество загруженных текстур
...
inline void AreaCompliteMenuCreate();
inline void ResumeLoadSaveCreate();
inline void YouAreDead_RIP();
inline void HighScoresForAreaCreate();
inline void BonusStageAMenuCreate();
inline void PlayVideoMovieMenuCreate();
inline void PlayVideoMovieIntroMenuCreate();
inline void BonusStageBMenuCreate();
inline void BonusStageCMenuCreate();
inline void NetworkGameMenuCreate();
inline void OptionsMenuCreate();
inline void NiceTryMenuCreate();
inline void CodeDebugMenuCreate();
inline void NetworkServerMenuCreate();
inline void NetworkClientMenuCreate();
